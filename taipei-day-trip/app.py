...
def api_attraction(attractionId):
    ...
    if attractionId.isdigit()==True :
        ...
        cursor1.execute("SELECT _id,name,CAT,description,address,direction,MRT,latitude,langinfo,file FROM attractions WHERE _id = %s",(attractionId,))#keyword,逗號不可刪
        attractionIdResult = cursor1.fetchall()
